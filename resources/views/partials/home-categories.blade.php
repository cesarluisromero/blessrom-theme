...
<section class="py-2"> 
  <div class="container mx-auto px-4">
    <div class="swiper category-swiper">
        ...
        @foreach($categories as $cat)          
            ...
            <div class="swiper-slide">
              <a href="{{ $cat_link . '?min_price=5&max_price=500&categorias%5B%5D=' . $cat_slug }}" class="bg-white rounded-2xl shadow-md hover:shadow-lg transition duration-300 p-10 flex flex-col items-center text-center">
                ...
                <h3 class="text-4xxl text-gray-700 mb-1 font-serif">{{ $cat->name }}</h3>
      ...
      <div class="swiper-button-next category-swiper-button-next text-blue-500 absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md"></div>
    </div>
  </div>
</section>
